...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class FirstPersonController : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            m_cameraOriginalFOV = m_Camera.fieldOfView;
        ...
        private void ToggleCrouch() //crouches/stands
        {
            ...
            if (m_IsCrouching) //if we are crouching check if there's anything above our head and if not then stand up
            {
                ...
                crouchCoroutine = StartCoroutine(PerformCrouch(m_Camera.transform.localPosition, m_OriginalCameraPosition));
            }
            ...
            else //crouch down
            {
                ...
                crouchCoroutine = StartCoroutine(PerformCrouch(m_Camera.transform.localPosition, Vector3.zero));
            }
        }
        ...
        private IEnumerator PerformCrouch(Vector3 startPos, Vector3 endPos) //lerps camera according to whether crouching or standing
        {
            ...
            while (lapsed < 1)
            {
                m_Camera.transform.localPosition = Vector3.Lerp(startPos, endPos, 1 - (1 - lapsed) * (1 - lapsed));
        ...
        private void Zoom(bool inOut)
        {
            ...
            m_Camera.fieldOfView += val;
            m_Camera.fieldOfView = Mathf.Clamp(m_Camera.fieldOfView, m_CameraZoomFOV, m_cameraOriginalFOV);
        }
